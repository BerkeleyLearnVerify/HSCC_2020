!function() {
        ...
        return e.e = function(t, e) {}, e.e = function(t, n) {
            ...
            if (void 0 !== i[t])
                ...
                o.type = "text/javascript", o.charset = "utf-8", o.async = !0, o.onerror = function() {
                    ...
                    2: "5b89bce04f133ec533459161985cf461",
	 ...
	 */
        ...
        function i(t, e, n) {
            var a;
            if (e)
                return n = n || e && e.ownerDocument, a = o.isType("function", t) ? t : r(t), e === n ? a(e) ? e : void 0 : a(e) ? e : i(a, e.parentNode, n)
        }
        var o = n(11);
        t.exports = {
            closest: i
        ...
        function a(t) {
            ...
            return t ? (e = t.split("&"), e.forEach(function(t) {
                var e = t.split("="),
                    ...
                    o = i(e[1]);
                if (2 == e.length)
                    return d.isType("array", n[r]) ? void n[r].push(o) : r in n ? (n[r] = [n[r]], void n[r].push(o)) : void (n[r] = o)
            }), n) : {}
        }
        function s(t, e) {
            var n = o(e);
        ...
        s = (new c).defaults({
            ...
            var n = e && "click" == e.type && f.closest("a", e.target),
                ...
                o = n && (l.ios() || l.android());
            if (h.isTwitterURL(t))
                return r || o ? this : (this.name = i(), this.popup = this.win.open(t, this.name, this.features), e && d.preventDefault(e), this)
        ...
        function s(t, e, n, r) {
            var i,
                ...
                a = !!e && !v.isObject(e);
            if (!o && !a)
                return i = m.flattenClientEventPayload(m.formatClientEventNamespace(t), m.formatClientEventData(e, n, r)), u(i)
        }
        function u(t) {
            return y.push(t), y
        }
        ...
        function r(t) {
            ...
            for (o = {}, t = t || a, e = t.getElementsByTagName("meta"); n = e[i]; i++)
                /^twitter:/.test(n.name) && (r = n.name.replace(/^twitter:/, ""), o[r] = n.content)
        }
        function i(t) {
            return o[t]
        }
            ...
            function t(t) {
                ...
                t = t || {}, this.params = Object.keys(this.paramConfigs).reduce(function(n, a) {
                    var s = [],
                        ...
                        d = c.validate || r,
                        f = c.transform || i;
                    if (a in u && s.push(u[a]), a in t && s.push(t[a]), s = "fallback" in c ? s.concat(c.fallback) : s, n[a] = o(s, d, f), c.required && null == n[a])
        ...
        function r(t) {
            var e;
            if (t)
                return e = t.lang || t.getAttribute("data-lang"), i.isType("string", e) ? e : r(t.parentElement)
        }
        var i = n(11);
        t.exports = r
    }, function(t, e, n) {
