__twttrll([2], {
        ...
        function s(t) {
            t.params({
                ...
                var t = h(f, {
                    ...
                    e = u.base() + t + "#" + a;
                return this.scribeImpression(), r.all([this.sandbox.setTitle(b), this.sandbox.addClass(w), this.sandbox.loadDocument(e)])
            })
        }
        var r = e(2),
            i = e(84),
    ...
    113: function(t, a) {
        t.exports = {
            tweetButtonHtmlPath: "/widgets/tweet_button.a0ec3119d8db2bc5422f2144c89ad7a9.{{lang}}.html",
            followButtonHtmlPath: "/widgets/follow_button.a0ec3119d8db2bc5422f2144c89ad7a9.{{lang}}.html",
        ...
        function o(t) {
            t.params({
                ...
                var t = this.params.text,
                    ...
                    s = d.getScreenNameFromPage();
                return "share" === this.params.type ? (t = t || m.title, a = a || d.getCanonicalURL() || h.href, e = e || s) : s && (n = n ? s + "," + n : s), f.compact({
                    id: this.id,
                    lang: this.params.lang,
                    size: this.params.size,
