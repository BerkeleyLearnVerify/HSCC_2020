/*1489215654,,JIT Construction: v2885019,en_US*/
...
try {
        ...
        (function() {
            ...
            with (this) {
                ...
                __d("JSSDKXDConfig", [], {
                    ...
                    "XdBundleUrl": "\/connect\/xd_arbiter\/r\/ao6eUeuGXQq.js?version=42",
                    "Flash": {
                ...
                __d('sdk.domReady', ['sdk.Runtime'], function a(b, c, d, e, f, g, h) {
                    var i,
                        j = 'readyState' in document ? /loaded|complete/.test(document.readyState) : !!document.body;
                    function k() {
                        if (!i)
                            return;
                        var n;
                ...
                __d('ApiClient', ['ArgumentError', 'Assert', 'CORSRequest', 'FlashRequest', 'flattenObject', 'JSONPRequest', 'Log', 'ObservableMixin', 'QueryString', 'sprintf', 'sdk.URI', 'UrlMap', 'ApiClientConfig', 'invariant', 'sdk.safelyParseResponse'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v) {
                    ...
                    function pa(va) {
                        var wa = na(va),
                            ...
                            za = wa.params.method,
                            ab,
                            bb = xa.removeQueryData('method').toString();
                ...
                __d('sdk.AppEvents', ['Assert', 'sdk.Impressions', 'sdk.Runtime', 'FBAppEvents', 'sdk.Auth'], function a(b, c, d, e, f, g, h, i, j, k, l) {
                    ...
                    function u(y) {
                        if (y === null || y.length === 0 || y.length > p || !new RegExp(q).test(y))
                            return false;
                        return true;
                    }
    ...
    new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"2885019","namespace":"FB","message":"' + e.message + '"}}');
}
